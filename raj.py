...
bot = telebot.TeleBot('8146887226:AAEpXFHjGB-jj-18pubAH5H7WC7l7XOLhgg') #<- यहां बोट टोकन डालो ।

# Admin user IDs
admin_id = ["1078086201"]  #⬅️ यहां यूज़र ID ✔️
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ғʀᴏᴍ @crossbeats7262
